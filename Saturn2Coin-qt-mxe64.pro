...
windows:RC_FILE = src/qt/res/saturncoin-qt.rc
...
macx:ICON = src/qt/res/icons/saturncoin.icns
...
LIBS += -lboost_system$$BOOST_LIB_SUFFIX -lboost_filesystem$$BOOST_LIB_SUFFIX -lboost_program_options$$BOOST_LIB_SUFFIX -lboost_thread+win32$$BOOST_THREAD_LIB_SUFFIX
